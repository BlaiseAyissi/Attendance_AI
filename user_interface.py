...
def putwindow():
    ...
    #window.geometry("800x500")
    tkinter.Label(window, text = "FACE DETECTION AND RECOGNITION ", fg = "black", bg = "darkorange").pack(fill = "x")
...
def show():
    ...
    tkinter.Label(window2, text = "FACE DETECTION AND RECOGNITION ", fg="black", bg="darkorange").pack(fill="x")
    ...
    tkinter.Label(window2, text = "Click 'TRAIN' to TRAIN and maybe 'TEST later' by making a classifer on the facenet model.\n\n"
                                  "Click 'TEST' to TEST on previously created dataset by loading already created      \n"
...
def show_run():
    ...
    tkinter.Label(window3, text = "FACE DETECTION AND RECOGNITION", fg="black", bg="darkorange").pack(fill="x")
...
def show_create():
    ...
    tkinter.Label(window4, text = "FACE DETECTION AND RECOGNITION", fg="black", bg="darkorange").pack(fill="x")
...
def show_train():
    ...
    tkinter.Label(window5, text = "FACE DETECTION AND RECOGNITION", fg="black", bg="darkorange").pack(fill="x")
...
def show_test():
    ...
    tkinter.Label(window6, text = "FACE DETECTION AND RECOGNITION", fg="black", bg="darkorange").pack(fill="x")
